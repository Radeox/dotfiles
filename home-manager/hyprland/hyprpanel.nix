{ ... }:
{
  ...
  programs.hyprpanel = {
    ...
    settings = {
      ...
      # Shortcuts and directories customization
      ...
      "menus.dashboard.shortcuts.left.shortcut2.command" = "flatpak run com.spotify.Client";
      "menus.dashboard.shortcuts.left.shortcut3.tooltip" = "Terminal";
      "menus.dashboard.shortcuts.left.shortcut3.icon" = "";
      "menus.dashboard.shortcuts.left.shortcut3.command" = "ghostty";
      "menus.dashboard.directories.left.directory3.label" = "󰚝 Sources";
      "menus.dashboard.directories.left.directory3.command" = "bash -c \"xdg-open $HOME/Sources/\"";
